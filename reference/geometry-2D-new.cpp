...
template <typename T>
double angle(const PointVector<T> &A, const PointVector<T> &O, const PointVector<T> &B)
{
...
template <typename T>
LineRaySegment<T> bisector(const PointVector<T> &A, const PointVector<T> &O, const PointVector<T> &B)
{
